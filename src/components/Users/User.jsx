...
//the display component of a specific user
export const User = ({
    //user ID
    id, 
    //user email
    ...
    //user avatar
    avatar, 
    //the function of sending an invitation to the user
    onClickInvite, 
    //the fixing flag of sending an invitation to the user
    isInvited
}) => (
    <li>
        <div>
        ...
        <img 
            ...
            className="action" 
            //illustration of fixing the sending of an invitation to user
